            ...
            <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
              ...
              <div className="w-full md:w-1/2 p-4 bg-light-blue-color">
                 ...
                 <div className="flex justify-between mt-2"> 
                  <div className="text-xg text-secondary-color font-extrabold">$1235</div>
                 <div>
                  <button className="rounded-md bg-secondary-color text-white font-bold p-4 w-44 mx-auto">Agregar al carrito</button>
                 </div>
                 </div>
                 ...
                 <div>
                    <h4 className="text-h4 font-extrabold mt-10">Características</h4>
                      ...
                      <h4 className="text-h5 font-medium">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</h4>
                 </div>
              </div>
              </div>  
          </div>
